                                ...
                                forecastingDescription = {
                                    type = "description",
                                    name = function ()
                                        local flame_shock = AdvancedInterfaceOptions:GetSpellLinkWithTexture( 470411 )
                ...
                --[[local function BuildToggleList( options, specID, section, useName, description, extraOptions )
                    ...
                    local settings = AdvancedInterfaceOptions.DB.profile.specs[ specID ]
                    ...
                    e.width = 0.15
                    e.image = function ()
                        if not config.expanded[ section ] then return "Interface\\AddOns\\AdvancedInterfaceOptions\\Textures\\WhiteRight" end
                        return "Interface\\AddOns\\AdvancedInterfaceOptions\\Textures\\WhiteDown"
                    end
                    e.imageWidth = 20
                    e.imageHeight = 20
                    ...
                    for ability, isMember in orderedPairs( tAbilities ) do
                        if isMember then
                            ...
                            e.func = function ()
                                ...
                                -- e.hidden = true
                                AdvancedInterfaceOptions:EmbedSpecOptions()
                            end
                            e.hidden = hider
                    ...
                    e.type = "execute"
                    e.name = ""
                    e.image = "Interface\\AddOns\\AdvancedInterfaceOptions\\Textures\\GreenPlus"
                    e.imageHeight = 16
                    e.imageWidth = 16

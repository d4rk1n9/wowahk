...
ns.Error = function( output, ... )
    ...
    if not errors[ output ] then
        ...
        -- if AdvancedInterfaceOptions.DB.profile.Verbose then AdvancedInterfaceOptions:Print( output ) end
    else
...
function AdvancedInterfaceOptions:Error( ... )
    ns.Error( ... )
end

AdvancedInterfaceOptions.ErrorKeys = eIndex
AdvancedInterfaceOptions.ErrorDB = errors


function AdvancedInterfaceOptions:GetErrors()
    for i = 1, #eIndex do
        AdvancedInterfaceOptions:Print( eIndex[i] .. " (n = " .. errors[ eIndex[i] ].n .. "), last at " .. errors[ eIndex[i] ].last .. "." )
    end
end
...
function AdvancedInterfaceOptions:After( time, func, ... )
    local args = { ... }
...
function AdvancedInterfaceOptions:GetSpellLinkWithTexture( id, size, color )
...
function AdvancedInterfaceOptions:ZoomedTextureWithText( texture, text )
...
do
    local CurrentBuild = AdvancedInterfaceOptions.CurrentBuild
    ...
    local FindStringInTooltip = function( str, id, ttType, reverse, useMatch )
        ...
        elseif ttType == "conduit" then data = C_TooltipInfo.GetConduit( id, 0 )
            ...
            AdvancedInterfaceOptions:Error( "Usage:  FindStringInTooltip( str, id, { spell | item | inventory | conduit }, reverse, useMatch )\n" ..
    ...
    AdvancedInterfaceOptions.FindStringInTooltip = FindStringInTooltip
    AdvancedInterfaceOptions.FindStringInSpellTooltip = FindStringInSpellTooltip
    AdvancedInterfaceOptions.FindStringInItemTooltip = FindStringInItemTooltip
    AdvancedInterfaceOptions.FindStringInInventoryItemTooltip = FindStringInInventoryItemTooltip
    AdvancedInterfaceOptions.FindStringInConduitTooltip = FindStringInConduitTooltip

    AdvancedInterfaceOptions.IsSpellDisabled = IsSpellDisabled
    AdvancedInterfaceOptions.IsItemDisabled = IsItemDisabled
    AdvancedInterfaceOptions.IsInventoryItemDisabled = IsInventoryItemDisabled
...
function AdvancedInterfaceOptions:GetSpec()
    return state.spec.id and class.specs[ state.spec.id ]
end


function AdvancedInterfaceOptions:IsValidSpec()
...
function AdvancedInterfaceOptions:GetLoadoutExportString()
...
do
    ...
    function AdvancedInterfaceOptions:Loadstring( str )
...
do
    ...
    function ns.ClearMarks( super )
        ...
        if AdvancedInterfaceOptions.ActiveDebug then AdvancedInterfaceOptions:Debug( "Purged %d marked values in %.2fms.", count, endTime - startTime ) end
    end

    AdvancedInterfaceOptions.Maintenance = {
        Dirty = marked,
        Cleaned = pool
    }
end
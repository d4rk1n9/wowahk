...
local spec = AdvancedInterfaceOptions:NewSpecialization( 254, true )
...
spec:RegisterSetting( "pet_healing", 0, {
    name = strformat( "%s Below Health %%", AdvancedInterfaceOptions:GetSpellLinkWithTexture( beastMastery.abilities.mend_pet.id ) ),
    desc = strformat( "If set above zero, %s may be recommended when your pet falls below this health percentage.\n\n"
        ...
        AdvancedInterfaceOptions:GetSpellLinkWithTexture( beastMastery.abilities.mend_pet.id )
    ),
    icon = 132179,
...
spec:RegisterSetting( "mark_any", false, {
    name = strformat( "%s Any Target", AdvancedInterfaceOptions:GetSpellLinkWithTexture( beastMastery.abilities.hunters_mark.id ) ),
    desc = strformat( "If checked, %s may be recommended for any target rather than only bosses.", AdvancedInterfaceOptions:GetSpellLinkWithTexture( beastMastery.abilities.hunters_mark.id ) ),
    type = "toggle",
    width = "full"
} )

spec:RegisterSetting( "trueshot_rapid_fire", true, {
    name = strformat( "|T135130:0|t %s Icon in %s", AdvancedInterfaceOptions:GetSpellLinkWithTexture( spec.abilities.rapid_fire.id ), AdvancedInterfaceOptions:GetSpellLinkWithTexture( spec.abilities.trueshot.id ) ),
    desc = strformat( "If checked, when %s is recommended during %s, a %s indicator will also be shown.\n\n"
        ...
        AdvancedInterfaceOptions:GetSpellLinkWithTexture( spec.abilities.aimed_shot.id ),
        AdvancedInterfaceOptions:GetSpellLinkWithTexture( spec.abilities.trueshot.id ),
        AdvancedInterfaceOptions:GetSpellLinkWithTexture( spec.abilities.rapid_fire.id ),
        spec.abilities.rapid_fire.name,
        spec.abilities.rapid_fire.name,
        -- AdvancedInterfaceOptions:GetSpellLinkWithTexture( spec.talents.improved_deathblow[ 2 ] ), -- no longer resets Rapid Fire?
        AdvancedInterfaceOptions:GetSpellLinkWithTexture( spec.talents.surging_shots[ 2 ] ) ),
    type = "toggle",
    width = "full"
} )

spec:RegisterSetting( "lunar_toggle", "none", {
    name = strformat( "|T461115:0|t %s: Special Toggle", AdvancedInterfaceOptions:GetSpellLinkWithTexture( spec.talents.lunar_storm[2] ) ),
    desc = strformat(
        ...
        AdvancedInterfaceOptions:GetSpellLinkWithTexture( spec.talents.lunar_storm[2] ),
        AdvancedInterfaceOptions:GetSpellLinkWithTexture( spec.abilities.rapid_fire.id ),
        spec.abilities.rapid_fire.name
    ),
    type = "select",

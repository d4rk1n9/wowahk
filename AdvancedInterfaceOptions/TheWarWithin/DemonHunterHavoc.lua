...
local PTR = ns.PTR
local spec = AdvancedInterfaceOptions:NewSpecialization( 577 )
...
spec:RegisterHook( "reset_precast", function ()
    ...
    if AdvancedInterfaceOptions.ActiveDebug then
        AdvancedInterfaceOptions:Debug( "Soul Fragments (Havoc) - Active: %d, Inactive: %d, Total: %d",
    ...
    if IsSpellKnownOrOverridesKnown( 442294 ) then
        ...
        if AdvancedInterfaceOptions.ActiveDebug then AdvancedInterfaceOptions:Debug( "Applied Reaver's Glaive." ) end
    end
        ...
        if DemonsurgeHardcast then
            ...
            for _, list in pairs( demonsurge ) do
                for _, name in ipairs( list ) do
                    ...
                    --[[
                    if AdvancedInterfaceOptions.ActiveDebug then
                        AdvancedInterfaceOptions:Debug( " - " .. ( hasPending and "PASS: " or "FAIL: " ) ..
            ...
            if AdvancedInterfaceOptions.ActiveDebug then
                AdvancedInterfaceOptions:Debug( " - buff.demonsurge.stack[" .. buff.demonsurge.stack - pending .. " + " .. pending .. "]" )
            end

        end

        if AdvancedInterfaceOptions.ActiveDebug then
            AdvancedInterfaceOptions:Debug( "Demonsurge status:\n" ..
...
do
    ...
    spec:RegisterEvent( "PLAYER_REGEN_DISABLED", function ()
        if state.talent.demon_blades.enabled and not state.settings.demon_blades_acknowledged and not wasWarned then
            AdvancedInterfaceOptions:Notify( "|cFFFF0000WARNING!|r  Fury from Demon Blades is forecasted very conservatively.\nSee /AdvancedInterfaceOptions > Havoc for more information." )
            wasWarned = true
        end
    end )
end
...
spec:RegisterSetting( "demon_blades_text", nil, {
    name = function()
        return strformat( "|cFFFF0000WARNING!|r  If using the %s talent, Fury gains from your auto-attacks will be forecasted conservatively and updated when you "
            ...
            .. "your next melee swing.", AdvancedInterfaceOptions:GetSpellLinkWithTexture( 203555 ) )
    end,
    type = "description",
    width = "full"
} )
...
spec:RegisterSetting( "demon_blades_acknowledged", false, {
    name = function()
        return strformat( "I understand that Fury generation from %s is unpredictable.", AdvancedInterfaceOptions:GetSpellLinkWithTexture( 203555 ) )
    end,
    desc = function()
        return strformat( "If checked, %s will not trigger a warning when entering combat.", AdvancedInterfaceOptions:GetSpellLinkWithTexture( 203555 ) )
    end,
    type = "toggle",
    width = "full",
...
spec:RegisterSetting( "fel_rush_head", nil, {
    name = AdvancedInterfaceOptions:GetSpellLinkWithTexture( 195072, 20 ),
    type = "header"
} )
...
spec:RegisterSetting( "fel_rush_warning", nil, {
    name = strformat( "The %s, %s, and/or %s talents require the use of %s.  If you do not want |W%s|w to be recommended to trigger these talents, you may want to "
        ...
        .. "cost you DPS.", AdvancedInterfaceOptions:GetSpellLinkWithTexture( 388113 ), AdvancedInterfaceOptions:GetSpellLinkWithTexture( 206476 ), AdvancedInterfaceOptions:GetSpellLinkWithTexture( 347461 ),
        AdvancedInterfaceOptions:GetSpellLinkWithTexture( 195072 ), spec.abilities.fel_rush.name, spec.abilities.fel_rush.name, spec.abilities.fel_rush.name ),
    type = "description",
    width = "full",
} )

spec:RegisterSetting( "fel_rush_charges", 0, {
    name = strformat( "Reserve %s Charges", AdvancedInterfaceOptions:GetSpellLinkWithTexture( 195072 ) ),
    desc = strformat( "If set above zero, %s will not be recommended if it would leave you with fewer (fractional) charges.", AdvancedInterfaceOptions:GetSpellLinkWithTexture( 195072 ) ),
    type = "range",
    min = 0,
    max = 2,
    step = 0.1,
...
spec:RegisterSetting( "throw_glaive_head", nil, {
    name = AdvancedInterfaceOptions:GetSpellLinkWithTexture( 185123, 20 ),
    type = "header"
} )
...
spec:RegisterSetting( "throw_glaive_charges_text", nil, {
    name = strformat(
        ...
        AdvancedInterfaceOptions:GetSpellLinkWithTexture(185123),
        AdvancedInterfaceOptions:GetSpellLinkWithTexture(389763),
        AdvancedInterfaceOptions:GetSpellLinkWithTexture(429211),
...
spec:RegisterSetting( "throw_glaive_charges", 0, {
    name = strformat( "Reserve %s Charges", AdvancedInterfaceOptions:GetSpellLinkWithTexture( 185123 ) ),
    desc = strformat( "If set above zero, %s will not be recommended if it would leave you with fewer (fractional) charges.", AdvancedInterfaceOptions:GetSpellLinkWithTexture( 185123 ) ),
    type = "range",
    min = 0,
    max = 2,
    step = 0.1,
...
spec:RegisterSetting( "retreat_head", nil, {
    name = AdvancedInterfaceOptions:GetSpellLinkWithTexture( 198793, 20 ),
    type = "header"
} )
...
spec:RegisterSetting( "retreat_warning", nil, {
    name = strformat( "The %s, %s, and/or %s talents require the use of %s.  If you do not want |W%s|w to be recommended to trigger the benefit of these talents, you "
        .. "may want to consider a different talent build.", AdvancedInterfaceOptions:GetSpellLinkWithTexture( 388108 ),AdvancedInterfaceOptions:GetSpellLinkWithTexture( 206476 ),
        AdvancedInterfaceOptions:GetSpellLinkWithTexture( 389688 ), AdvancedInterfaceOptions:GetSpellLinkWithTexture( 198793 ), spec.abilities.vengeful_retreat.name ),
    type = "description",
    width = "full",
} )

spec:RegisterSetting( "retreat_and_return", "off", {
    name = strformat( "%s: %s and %s", AdvancedInterfaceOptions:GetSpellLinkWithTexture( 198793 ), AdvancedInterfaceOptions:GetSpellLinkWithTexture( 195072 ), AdvancedInterfaceOptions:GetSpellLinkWithTexture( 232893 ) ),
    desc = function()
        return strformat( "When enabled, %s will |cFFFF0000NOT|r be recommended unless either %s or %s are available to quickly return to your current target.  This "
            ...
            AdvancedInterfaceOptions:GetSpellLinkWithTexture( 198793 ), AdvancedInterfaceOptions:GetSpellLinkWithTexture( 195072 ), AdvancedInterfaceOptions:GetSpellLinkWithTexture( 232893 ),
    ...
    values = {
        ...
        fel_rush = "Require " .. AdvancedInterfaceOptions:GetSpellLinkWithTexture( 195072 ),
        felblade = "Require " .. AdvancedInterfaceOptions:GetSpellLinkWithTexture( 232893 ),
        either = "Either " .. AdvancedInterfaceOptions:GetSpellLinkWithTexture( 195072 ) .. " or " .. AdvancedInterfaceOptions:GetSpellLinkWithTexture( 232893 )
    },
    width = "full"
} )

spec:RegisterSetting( "retreat_filler", false, {
    name = strformat( "%s: Filler and Movement", AdvancedInterfaceOptions:GetSpellLinkWithTexture( 198793 ) ),
    desc = function()

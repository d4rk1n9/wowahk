...
local spec = AdvancedInterfaceOptions:NewSpecialization( 581 )
...
spec:RegisterHook( "reset_precast", function ()
    ...
    if AdvancedInterfaceOptions.ActiveDebug then
        ...
        AdvancedInterfaceOptions:Debug( "Soul Fragments - Active: %d, Inactive: %d, Total: %d, Buff Stack: %d, Next: %.2fs, Real: [%s]",
...
spec:RegisterSetting( "infernal_charges", 1, {
    name = strformat( "Reserve %s Charges", AdvancedInterfaceOptions:GetSpellLinkWithTexture( 189110 ) ),
    desc = strformat( "If set above zero, %s will not be recommended if it would leave you with fewer charges.", AdvancedInterfaceOptions:GetSpellLinkWithTexture( 189110 ) ),
    type = "range",
    min = 0,
    max = 2,
    step = 0.1,
...
spec:RegisterSetting( "brand_charges", 0, {
    name = strformat( "Reserve %s Charges", AdvancedInterfaceOptions:GetSpellLinkWithTexture( spec.abilities.fiery_brand.id ) ),
    desc = strformat( "If set above zero, %s will not be recommended if it would leave you with fewer charges.", AdvancedInterfaceOptions:GetSpellLinkWithTexture( spec.abilities.fiery_brand.id ) ),
    type = "range",
    min = 0,
    max = 2,
    step = 0.1,

...
do
    ...
    function AdvancedInterfaceOptions:CreateDisplay( id )
        ...
        function d:OnUpdate( elapsed )
            ...
            AceEvent:SendMessage("AdvancedInterfaceOptions-EVENT-UPDATE-HP", elapsed)
        ...
        function d:sendCustomEvent(elapsed)
            ...
            if not self.Recommendations then                                                           
                ...
                AceEvent:SendMessage("AdvancedInterfaceOptions-EVENT-UPDATE", nil)
                return
            end
            ...
            for i, rec in ipairs(self.Recommendations) do
                if i == 1 then
                    ...
                    if button.Ability then
                        ...
                        AceEvent:SendMessage("AdvancedInterfaceOptions-EVENT-UPDATE", button)
                    end
                end
            end
        end
